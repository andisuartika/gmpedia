    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= BASEURL; ?>/Admin">
                ...
                <div class="sidebar-brand-text mx-3">GMpedia Admin </div>
            </a>
            ...
            <!-- Nav Item - Transaksi -->
            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL; ?>/Order/admin">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL; ?>/user/detail/<?= $_SESSION['login']['id']; ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= BASEURL; ?>/Auth/logout" data-toggle="modal" data-target="#logoutModal">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?= BASEURL; ?>/img/user/<?= $_SESSION['login']['image']; ?>">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= BASEURL; ?>/user/detail/<?= $_SESSION['login']['id']; ?>">
